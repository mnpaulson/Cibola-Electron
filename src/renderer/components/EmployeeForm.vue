    ...
    <v-flex xs12 sm6>
        <v-card>
            ...
            <v-card-text>
                ...
                <v-btn outline v-show="!currentEmployee.id" small color="primary" @click="createEmployee">Add</v-btn>
                <v-btn outline v-show="currentEmployee.id" small color="primary" @click="updateEmployee">Update</v-btn>
            </v-card-text>
            <v-card-text>
                <v-list dense>
